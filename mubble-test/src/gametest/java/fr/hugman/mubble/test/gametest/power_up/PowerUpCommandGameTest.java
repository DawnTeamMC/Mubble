...
public class PowerUpCommandGameTest {
    ...
    public void setGivesThePowerUp(GameTestHelper helper) {
        ...
        TestCommands.run(helper, player, "power_up set @s super_mario:fire");
    ...
    public void setReachesADataPackPowerUpToo(GameTestHelper helper) {
        ...
        TestCommands.run(helper, player, "power_up set @s mubble-gametest:shooter");
    ...
    public void removeTakesThePowerUpBack(GameTestHelper helper) {
        ...
        TestCommands.run(helper, player, "power_up remove @s");
    ...
    public void handingOutTheSamePowerUpTwiceFails(GameTestHelper helper) {
        ...
        helper.assertFalse(TestCommands.succeeds(helper, player, "power_up set @s super_mario:fire"),
    ...
    public void removingNothingFails(GameTestHelper helper) {
        ...
        helper.assertFalse(TestCommands.succeeds(helper, player, "power_up remove @s"),
    ...
    public void anUnknownPowerUpIsRefused(GameTestHelper helper) {
        ...
        helper.assertFalse(TestCommands.succeeds(helper, player, "power_up set @s super_mario:not_a_real_power_up"),
