 ...
 * to have started on the ground, and it is lost the moment the entity slows to a walk, runs into a
 * wall or goes under. The state is kept here rather than worked out by the collision code, because whether
 * the water is solid depends on where the sprint comes from and not only on what the current tick
 * looks like.
 *
 * @author Hugman
 * @since v4.0.0
