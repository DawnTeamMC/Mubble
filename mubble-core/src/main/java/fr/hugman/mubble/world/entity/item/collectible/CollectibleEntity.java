...
public class CollectibleEntity extends Entity {
    ...
    private static final String TAG_COLLECT_PARTICLE = "bounce_sound";
    ...
    protected ParticleOptions collectParticle;
    ...
    @Nullable
    public ParticleOptions getCollectParticle() {
        return collectParticle;
    }

    public void setCollectParticle(ParticleOptions collectParticle) {
    ...
    protected void addAdditionalSaveData(ValueOutput output) {
        if (!this.getItem().isEmpty()) {
            ...
            output.storeNullable(TAG_COLLECT_PARTICLE, ParticleTypes.CODEC, this.getCollectParticle());
    ...
    protected void readAdditionalSaveData(ValueInput input) {
        ...
        this.setCollectParticle(input.read(TAG_COLLECT_PARTICLE, ParticleTypes.CODEC).orElse(null));
            ...
            if (player.getInventory().add(itemStack)) {
                ...
                if (!this.isRemoved()) {
                    for(var tracking : PlayerLookup.tracking(this)) {
                        ServerPlayNetworking.send(tracking, new CollectCollectiblePayload(this.getId(), orgCount, Optional.ofNullable(getCollectParticle())));
                    }
                }
