...
public class BlockUnstable extends BlockBase implements IHasModel
{
	...
	public void onFallenUpon(World worldIn, BlockPos pos, Entity entityIn, float fallDistance)
    {
		...
		if(!worldIn.isRemote && this == BlockInit.UNSTABLE_STONE) destroy(worldIn, pos);
    }
    ...
    {
        if (!worldIn.isRemote && this == BlockInit.REWIND_BLOCK)
        {
    ...
    {
        if (this == BlockInit.UNSTABLE_STONE) return BlockRenderLayer.CUTOUT_MIPPED;
