...
package fr.hugman.mubble.super_mario.core.particles;
...
public class SuperMarioParticleTypes {
	...
	private static SimpleParticleType register(String name) {
		return Registry.register(BuiltInRegistries.PARTICLE_TYPE, SuperMario.id(name), FabricParticleTypes.simple());
	}
	private static SimpleParticleType register(String name, boolean overrideLimiter) {
		return Registry.register(BuiltInRegistries.PARTICLE_TYPE, SuperMario.id(name), FabricParticleTypes.simple(overrideLimiter));
	}
}
