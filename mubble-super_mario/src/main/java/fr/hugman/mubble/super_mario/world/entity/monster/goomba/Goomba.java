...
public class Goomba extends SuperMarioEnemy implements Surprisable, Stunnable {
    ...
    public void onSurprised() {
        this.playSound(SuperMarioSounds.GOOMBA_FIND_TARGET, 1.0F, 1.0F);
    ...
    protected void playStepSound(BlockPos pos, BlockState state) {
        ...
        if (this.getTarget() != null) {
            this.playSound(SuperMarioSounds.GOOMBA_RUN_STEP, 1.0F, 1.0F);
        } else {
            this.playSound(SuperMarioSounds.GOOMBA_WALK_STEP, 1.0F, 1.0F);
        }
    }
