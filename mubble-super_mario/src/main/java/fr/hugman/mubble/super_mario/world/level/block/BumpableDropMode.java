...
public enum BumpableDropMode implements StringRepresentable {
    ...
    BumpableDropMode(int index, String id) {
        this.index = index;
        this.id = id;
        this.name = Component.translatable("block." + SuperMario.MOD_ID + ".bumpable.drop." + id);
        this.description = Component.translatable("block." + SuperMario.MOD_ID + ".bumpable.drop." + id + ".description");
    }
