...
public class GoombaAnimations {
    public static final AnimationDefinition WALKING = AnimationDefinition.Builder.create(1.0F).looping()
            ...
            .addBoneAnimation(EntityModelPartNames.RIGHT_FOOT, new Transformation(Transformation.Targets.MOVE_ORIGIN,
            ...
            .addBoneAnimation(EntityModelPartNames.LEFT_FOOT, new Transformation(Transformation.Targets.MOVE_ORIGIN,
    ...
    public static final AnimationDefinition SURPRISE = AnimationDefinition.Builder.create(0.5F)
            .addBoneAnimation(EntityModelPartNames.ROOT, new Transformation(Transformation.Targets.ROTATE,
            ...
            .addBoneAnimation(GoombaModel.RIGHT_EYEBROW, new Transformation(Transformation.Targets.MOVE_ORIGIN,
                    new Keyframe(0.0F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC),
            ...
            .addBoneAnimation(GoombaModel.LEFT_EYEBROW, new Transformation(Transformation.Targets.MOVE_ORIGIN,
                    new Keyframe(0.0F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC),
                    new Keyframe(0.25F, AnimationHelper.createTranslationalVector(0.5F, 1.0F, 0.0F), Transformation.Interpolations.CUBIC),
                    new Keyframe(0.4167F, AnimationHelper.createTranslationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.CUBIC)
            ))
    ...
    public static final AnimationDefinition CRUSH = AnimationDefinition.Builder.create(1f)
            .addBoneAnimation(EntityModelPartNames.ROOT, new Transformation(Transformation.Targets.MOVE_ORIGIN,
