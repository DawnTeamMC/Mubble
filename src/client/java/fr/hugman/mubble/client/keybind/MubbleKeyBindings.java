...
public class MubbleKeyBindings {
    public static final KeyMapping TRIGGER_POWER_UP = of(GLFW.GLFW_KEY_R, MubbleKeyBindingsKeys.TRIGGER_POWER_UP, KeyMapping.Category.GAMEPLAY);

    public static KeyMapping of(int code, String translationKey, KeyMapping.Category categoryTranslationKey) {
