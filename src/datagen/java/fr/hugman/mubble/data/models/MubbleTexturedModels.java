...
public class MubbleTexturedModels {
    public static TexturedModel.Provider brickBlock(String color) {
        return TexturedModel.createDefault(block -> TextureMapping.cube(Mubble.id("block/brick_block_" + color)), net.minecraft.client.data.models.model.ModelTemplates.CUBE_ALL);
    }
    ...
    public static TexturedModel.Provider exclamationBlock(String color) {
        return TexturedModel.createDefault(block -> new TextureMapping()
                ...
                MubbleModelTemplates.CUBE_COLUMN_ALTERNATING);
    }
    ...
    public static TexturedModel.Provider eggBlock(String color) {
        ...
        ), MubbleModelTemplates.EGG_BLOCK);
    }

    public static TexturedModel.Provider beepBlock(String color) {
        return TexturedModel.createDefault(block -> TextureMapping.cube(Mubble.id("block/beep_block/" + color)), net.minecraft.client.data.models.model.ModelTemplates.CUBE_ALL);
