...
public class MubbleItemTagProvider extends FabricTagProvider.ItemTagProvider {
	public MubbleItemTagProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture, @Nullable BlockTagProvider blockTagProvider) {
