...
public class MubbleTrackedData {
    ...
    public static final TrackedDataHandler<Optional<RegistryEntry<PowerUp>>> OPTIONAL_POWER_UP = of("optional_power_up", PowerUp.OPTIONAL_ENTRY_PACKET_CODEC);
    public static final TrackedDataHandler<PowerUpProperties> POWER_UP_PROPERTIES = of("power_up_properties", PowerUpProperties.PACKET_CODEC);
