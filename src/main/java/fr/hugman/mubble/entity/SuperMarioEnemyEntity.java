 ...
 * @since v4.0.0
 */
abstract public class SuperMarioEnemyEntity extends Monster {
    protected static final EntityDataAccessor<Boolean> STOMPED = SynchedEntityData.defineId(SuperMarioEnemyEntity.class, EntityDataSerializers.BOOLEAN);

    protected SuperMarioEnemyEntity(EntityType<? extends Monster> entityType, Level world) {
