...
public class KoopaShellItem extends Item implements ProjectileItem {
    public KoopaShellItem(Item.Settings settings) {
        super(settings);
    }
    ...
    public ActionResult use(World world, PlayerEntity user, Hand hand) {
        ...
        if (!world.isClient) {
            KoopaShellEntity koopaShellEntity = new KoopaShellEntity(world, user);
    ...
    public ProjectileEntity createEntity(World world, Position pos, ItemStack stack, Direction direction) {
        return new KoopaShellEntity(world, pos.getX(), pos.getY(), pos.getZ());
    }
}
