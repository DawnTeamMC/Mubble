...
public class MubbleItems {
    ...
    public static final KoopaShellItem GREEN_KOOPA_SHELL = of(MubbleItemKeys.GREEN_KOOPA_SHELL, KoopaShellItem::new, new Item.Settings().maxCount(3)));
    public static final KoopaShellItem RED_KOOPA_SHELL = of(MubbleItemKeys.RED_KOOPA_SHELL, KoopaShellItem::new, new Item.Settings().maxCount(3)));
