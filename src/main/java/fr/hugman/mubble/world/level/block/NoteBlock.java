...
public class NoteBlock extends DecoratedBumpableBlock {
    ...
    public void updateEntityMovementAfterFallOn(BlockGetter view, Entity entity) {
        ...
        this.onHit(world, state, entity, new BlockHitResult(entity.position(), Direction.UP, pos, false));
    ...
    public void launchEntitiesOnTop(Level world, BlockPos pos) {
        ...
        world.playSound(null, center.x(), center.y(), center.z(), shouldPlayHighSound ? this.highJumpSound : this.lowJumpSound, SoundSource.BLOCKS, 1F, 1F);
    }
    ...
    public void addParticles(Level world, BlockPos blockPos) {
