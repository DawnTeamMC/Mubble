...
public class GoldFireball extends Ball {
	...
	protected void finalHit(SoundEvent deathSound) {
		...
		this.level().explode(this, this.damageSources().source(MubbleDamageTypeKeys.GOLD_FIREBALL, this, this.getOwner()), null, this.getX(), this.getY(0.0625F), this.getZ(), 3.0F, false, Level.ExplosionInteraction.TNT);
	}
