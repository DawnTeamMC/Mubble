...
public record GoombaVariant(
	...
	public static final Codec<Holder<GoombaVariant>> ENTRY_CODEC = RegistryFixedCodec.create(MubbleRegistries.GOOMBA_VARIANT);
	public static final StreamCodec<RegistryFriendlyByteBuf, Holder<GoombaVariant>> ENTRY_PACKET_CODEC = ByteBufCodecs.holderRegistry(MubbleRegistries.GOOMBA_VARIANT);
