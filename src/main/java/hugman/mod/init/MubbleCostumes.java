...
public class MubbleCostumes
{
	...
	public static final Item TOP_HAT = new CostumeHeadBase("top_hat", SoundEvents.ITEM_ARMOR_EQUIP_LEATHER);
	...
	public static final Item SNORLAX_HAT = new CostumeHeadBase("snorlax_hat", SoundEvents.ITEM_ARMOR_EQUIP_LEATHER);
	public static final Item KING_ROUND_MASK = new CostumeHeadBase("king_round_mask", SoundEvents.ITEM_ARMOR_EQUIP_LEATHER);
}
