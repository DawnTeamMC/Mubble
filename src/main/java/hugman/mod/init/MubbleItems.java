...
public class MubbleItems
{
    ...
    public static final Item BISMUTH_DUST = new ItemSimple("bismuth_dust", ItemGroup.MATERIALS);
    public static final Item CRYSTALLIZED_BISMUTH = new ItemSimple("crystallized_bismuth", ItemGroup.MATERIALS);
    ...
    */
    ...
    public static final Item GOOMBA_SPAWN_EGG = new ItemSpawnEgg("goomba", MubbleEntities.GOOMBA, 10839375, 12097909);
