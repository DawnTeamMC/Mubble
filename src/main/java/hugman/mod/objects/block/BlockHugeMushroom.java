...
{   
    ...
    {
    	if(this == MubbleBlocks.BLUE_MUSHROOM_BLOCK) return Item.getItemFromBlock(MubbleBlocks.BLUE_MUSHROOM);
    	else if(this == MubbleBlocks.GREEN_MUSHROOM_BLOCK) return Item.getItemFromBlock(MubbleBlocks.GREEN_MUSHROOM);
    	else if(this == MubbleBlocks.YELLOW_MUSHROOM_BLOCK) return Item.getItemFromBlock(MubbleBlocks.YELLOW_MUSHROOM);
    	else if(this == MubbleBlocks.PURPLE_MUSHROOM_BLOCK) return Item.getItemFromBlock(MubbleBlocks.PURPLE_MUSHROOM);
		return null;
    }
