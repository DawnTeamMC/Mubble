...
public class TreeTallFeature extends AbstractTreeFeature<NoFeatureConfig>
{
    ...
    public TreeTallFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactory, boolean notify, Block log, Block leaves, Block sapling)
    {
    ...
    private int makeLimb(Set<BlockPos> p_208523_1_, IWorldGenerationReader p_208523_2_, BlockPos p_208523_3_, BlockPos p_208523_4_, boolean p_208523_5_, MutableBoundingBox p_208523_6_) {
      if (!p_208523_5_ && Objects.equals(p_208523_3_, p_208523_4_)) {
         ...
         for(int j = 0; j <= i; ++j) {
            ...
            if (p_208523_5_) {
                this.setLogState(p_208523_1_, p_208523_2_, blockpos1, LOG.with(LogBlock.AXIS, this.getLoxAxis(p_208523_3_, blockpos1)), p_208523_6_);
    ...
    private void makeFoliage(IWorldGenerationReader p_208525_1_, int p_208525_2_, BlockPos p_208525_3_, List<TreeTallFeature.FoliageCoordinates> p_208525_4_, MutableBoundingBox p_208525_5_, Set<BlockPos> p_208525_6_) {
      for(TreeTallFeature.FoliageCoordinates TreeTallFeature$foliagecoordinates : p_208525_4_) {
         if (this.trimBranches(p_208525_2_, TreeTallFeature$foliagecoordinates.getBranchBase() - p_208525_3_.getY())) {
    ...
    private void makeBranches(Set<BlockPos> p_208524_1_, IWorldGenerationReader p_208524_2_, int p_208524_3_, BlockPos p_208524_4_, List<TreeTallFeature.FoliageCoordinates> p_208524_5_, MutableBoundingBox p_208524_6_) {
      for(TreeTallFeature.FoliageCoordinates TreeTallFeature$foliagecoordinates : p_208524_5_) {
                ...
                for(int j1 = 0; j1 < k; ++j1) {
                  ...
                  if (this.makeLimb(changedBlocks, worldIn, blockpos, blockpos1, false, p_208519_5_) == -1) {
                     ...
                     if (this.makeLimb(changedBlocks, worldIn, blockpos2, blockpos, false, p_208519_5_) == -1) {
                        list.add(new TreeTallFeature.FoliageCoordinates(blockpos, blockpos2.getY()));
                     }
                  }
                }
            }
