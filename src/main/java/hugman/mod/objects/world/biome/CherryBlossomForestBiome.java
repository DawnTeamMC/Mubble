...
public class CherryBlossomForestBiome extends Biome
{
	public CherryBlossomForestBiome()
	{
		...
		this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, createCompositeFeature(Feature.RANDOM_FEATURE_LIST, new RandomDefaultFeatureListConfig(new Feature[]{Feature.BIRCH_TREE, MubbleFeatures.TALL_CHERRY_BLOSSOM_TREE}, new IFeatureConfig[]{IFeatureConfig.NO_FEATURE_CONFIG, IFeatureConfig.NO_FEATURE_CONFIG}, new float[]{0.2F, 0.1F}, MubbleFeatures.CHERRY_BLOSSOM_TREE, IFeatureConfig.NO_FEATURE_CONFIG), AT_SURFACE_WITH_EXTRA, new AtSurfaceWithExtraConfig(10, 0.1F, 1)));
        ...
        this.setRegistryName(Mubble.MOD_ID, "cherry_blossom_forest");
