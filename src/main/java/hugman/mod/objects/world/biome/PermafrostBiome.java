...
public class PermafrostBiome extends Biome
{
	public PermafrostBiome()
	{
        ...
        this.addFeature(GenerationStage.Decoration.UNDERGROUND_DECORATION, createCompositeFeature(MubbleWorld.Features.PERMAFROST_WATER, new HellLavaConfig(false), COUNT_RANGE, new CountRangeConfig(8, 4, 8, 128)));
