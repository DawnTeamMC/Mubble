...
public class MubbleOreFeature extends Feature<MubbleOreFeatureConfig>
{
	public MubbleOreFeature(Function<Dynamic<?>, ? extends MubbleOreFeatureConfig> configFactory) {
		super(configFactory);
	}
	
	public boolean generate(IWorld iWorld, ChunkGenerator<? extends ChunkGeneratorConfig> chunkGenerator, Random random, BlockPos blockPos, MubbleOreFeatureConfig oreFeatureConfig)
	{
	...
	protected boolean generateVeinPart(IWorld world, Random random, MubbleOreFeatureConfig config, double startX, double endX, double startZ, double endZ, double startY, double endY, int x, int y, int z, int size, int i)
	{
		int j = 0;
