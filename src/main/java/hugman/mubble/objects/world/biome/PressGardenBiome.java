...
public class PressGardenBiome extends Biome
{
	public PressGardenBiome()
	{
	    ...
	    this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(ImmutableList.of(MubbleFeatures.PINK_PRESS_GARDEN_TREE.configure(new BranchedTreeFeatureConfig.Builder(new SimpleStateProvider(MubbleBlocks.PRESS_GARDEN_LOG.getDefaultState()), new SimpleStateProvider(MubbleBlocks.PINK_PRESS_GARDEN_LEAVES.getDefaultState()), new BlobFoliagePlacer(2, 0)).build()).withChance(0.1F), MubbleFeatures.PINK_PRESS_GARDEN_GROUND_BUSH.configure(new TreeFeatureConfig.Builder(new SimpleStateProvider(MubbleBlocks.PRESS_GARDEN_LOG.getDefaultState()), new SimpleStateProvider(MubbleBlocks.PINK_PRESS_GARDEN_LEAVES.getDefaultState())).build()).withChance(0.3F), MubbleFeatures.MEGA_RED_PRESS_GARDEN_TREE.configure(new MegaTreeFeatureConfig.Builder(new SimpleStateProvider(MubbleBlocks.PRESS_GARDEN_LOG.getDefaultState()), new SimpleStateProvider(MubbleBlocks.RED_PRESS_GARDEN_LEAVES.getDefaultState())).build()).withChance(0.6F)), MubbleFeatures.RED_PRESS_GARDEN_TREE.configure(new BranchedTreeFeatureConfig.Builder(new SimpleStateProvider(MubbleBlocks.PRESS_GARDEN_LOG.getDefaultState()), new SimpleStateProvider(MubbleBlocks.RED_PRESS_GARDEN_LEAVES.getDefaultState()), new BlobFoliagePlacer(2, 0)).build()).createDecoratedFeature(Decorator.COUNT_EXTRA_HEIGHTMAP.configure(new CountExtraChanceDecoratorConfig(50, 0.1F, 1))))));
		...
		this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.RANDOM_PATCH.configure(new RandomPatchFeatureConfig.Builder(new SimpleStateProvider(MubbleBlocks.PINK_PRESS_GARDEN_LEAF_PILE.getDefaultState()), new SimpleBlockPlacer()).build()).createDecoratedFeature(Decorator.COUNT_HEIGHTMAP_DOUBLE.configure(new CountDecoratorConfig(2))));
	 	this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, MubbleFeatures.BLUEBERRY_BUSH.configure(new RandomPatchFeatureConfig.Builder(new SimpleStateProvider(MubbleBlocks.BLUEBERRY_BUSH.getDefaultState().with(SweetBerryBushBlock.AGE, Integer.valueOf(3))), new SimpleBlockPlacer()).build()).createDecoratedFeature(Decorator.CHANCE_HEIGHTMAP_DOUBLE.configure(new ChanceDecoratorConfig(12))));
