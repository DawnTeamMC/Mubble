...
public class PermafrostBiome extends Biome
{
    ...
    {    	
        ...
        //this.addFeature(GenerationStep.Feature.UNDERGROUND_DECORATION, Feature.ORE.configure(new OreFeatureConfig(MubbleFeatureConfigs.PERMAROCK_FILLER, BISMUTH_ORE, 14)).createDecoratedFeature(Decorator.COUNT_RANGE.configure(new RangeDecoratorConfig(16, 10, 20, 128))));
        //this.addFeature(GenerationStep.Feature.UNDERGROUND_DECORATION, Feature.ORE.configure(new OreFeatureConfig(MubbleFeatureConfigs.PERMAROCK_FILLER, SEA_LANTERN, 33)).createDecoratedFeature(Decorator.MAGMA.configure(new CountDecoratorConfig(4))));
