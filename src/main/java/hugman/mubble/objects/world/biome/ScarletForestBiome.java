...
public class ScarletForestBiome extends Biome
{
    public ScarletForestBiome()
    {
        ...
        this.addFeature(GenerationStep.Feature.VEGETAL_DECORATION, Feature.RANDOM_SELECTOR.configure(new RandomFeatureConfig(ImmutableList.of(MubbleFeatures.LARGE_SCARLET_TREE.configure(FeatureConfig.DEFAULT).withChance(0.6666667F), MubbleFeatures.TALL_SCARLET_TREE.configure(FeatureConfig.DEFAULT).withChance(0.1F), MubbleFeatures.SCARLET_GROUND_BUSH.configure(FeatureConfig.DEFAULT).withChance(0.1F)), MubbleFeatures.SCARLET_TREE.configure(FeatureConfig.DEFAULT).createDecoratedFeature(Decorator.DARK_OAK_TREE.configure(DecoratorConfig.DEFAULT)))));
