...
public class HugeNetherBrownMushroomFeature extends HugeBrownMushroomFeature
{
	public HugeNetherBrownMushroomFeature(Codec<HugeMushroomFeatureConfig> codec)
	{
		super(codec);
	}
