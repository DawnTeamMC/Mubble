...
public class LightsaberItem extends SwordItem
{
	...
	public void onPullOut(Entity entity, World world)
	{
		...
		{
    		SSpawnMovingSoundEffectPacket sstopsoundpacket = new SSpawnMovingSoundEffectPacket(MubbleSounds.ITEM_LIGHTSABER_IDLE, SoundCategory.MASTER, entity, 0.15F, 1.0F);
    		((ServerPlayerEntity)entity).connection.sendPacket(sstopsoundpacket);
		}
	}
