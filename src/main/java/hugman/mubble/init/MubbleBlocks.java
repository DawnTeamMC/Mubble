...
public class MubbleBlocks {
	...
	public static final MSBlockCreator PALM_WOOD_BLOCKS = new MSBlockCreator("palm", PALM_LOGS.getWood(), BlockTemplate.STAIRS, BlockTemplate.SLAB, BlockTemplate.VERTICAL_SLAB, BlockTemplate.WOOD_BUTTON);
