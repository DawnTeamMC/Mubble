...
public class MubbleBlocks {
	...
	/* MUBBLE */
	public static final Block OAK_VERTICAL_SLAB = register("oak_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.OAK_PLANKS)), ItemGroup.BUILDING_BLOCKS, 5, 20);
	public static final Block SPRUCE_VERTICAL_SLAB = register("spruce_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.SPRUCE_PLANKS)), ItemGroup.BUILDING_BLOCKS, 5, 20);
	public static final Block BIRCH_VERTICAL_SLAB = register("birch_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.BIRCH_PLANKS)), ItemGroup.BUILDING_BLOCKS, 5, 20);
	public static final Block JUNGLE_VERTICAL_SLAB = register("jungle_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.JUNGLE_PLANKS)), ItemGroup.BUILDING_BLOCKS, 5, 20);
	public static final Block ACACIA_VERTICAL_SLAB = register("acacia_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.ACACIA_PLANKS)), ItemGroup.BUILDING_BLOCKS, 5, 20);
	public static final Block DARK_OAK_VERTICAL_SLAB = register("dark_oak_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.DARK_OAK_PLANKS)), ItemGroup.BUILDING_BLOCKS, 5, 20);
	public static final Block STONE_VERTICAL_SLAB = register("stone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.STONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_STONE_VERTICAL_SLAB = register("smooth_stone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.SMOOTH_STONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block COBBLESTONE_VERTICAL_SLAB = register("cobblestone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.COBBLESTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block MOSSY_COBBLESTONE_VERTICAL_SLAB = register("mossy_cobblestone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.MOSSY_COBBLESTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block STONE_BRICK_VERTICAL_SLAB = register("stone_brick_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.STONE_BRICKS)), ItemGroup.BUILDING_BLOCKS);
	public static final Block MOSSY_STONE_BRICK_VERTICAL_SLAB = register("mossy_stone_brick_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.MOSSY_STONE_BRICKS)), ItemGroup.BUILDING_BLOCKS);
	public static final Block GRANITE_VERTICAL_SLAB = register("granite_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.GRANITE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block POLISHED_GRANITE_VERTICAL_SLAB = register("polished_granite_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.POLISHED_GRANITE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block DIORITE_VERTICAL_SLAB = register("diorite_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.DIORITE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block POLISHED_DIORITE_VERTICAL_SLAB = register("polished_diorite_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.POLISHED_DIORITE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block ANDESITE_VERTICAL_SLAB = register("andesite_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.ANDESITE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block POLISHED_ANDESITE_VERTICAL_SLAB = register("polished_andesite_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.POLISHED_ANDESITE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block BRICK_VERTICAL_SLAB = register("brick_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.BRICKS)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SANDSTONE_VERTICAL_SLAB = register("sandstone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block CUT_SANDSTONE_VERTICAL_SLAB = register("cut_sandstone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.CUT_SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_SANDSTONE_VERTICAL_SLAB = register("smooth_sandstone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.SMOOTH_SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block RED_SANDSTONE_VERTICAL_SLAB = register("red_sandstone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.RED_SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block CUT_RED_SANDSTONE_VERTICAL_SLAB = register("cut_red_sandstone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.CUT_RED_SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_RED_SANDSTONE_VERTICAL_SLAB = register("smooth_red_sandstone_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.SMOOTH_RED_SANDSTONE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block NETHER_BRICK_VERTICAL_SLAB = register("nether_brick_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.NETHER_BRICKS)), ItemGroup.BUILDING_BLOCKS);
	public static final Block RED_NETHER_BRICK_VERTICAL_SLAB = register("red_nether_brick_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.RED_NETHER_BRICKS)), ItemGroup.BUILDING_BLOCKS);
	public static final Block QUARTZ_VERTICAL_SLAB = register("quartz_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.QUARTZ_BLOCK)), ItemGroup.BUILDING_BLOCKS);
	public static final Block SMOOTH_QUARTZ_VERTICAL_SLAB = register("smooth_quartz_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.SMOOTH_QUARTZ)), ItemGroup.BUILDING_BLOCKS);
	public static final Block END_STONE_BRICK_VERTICAL_SLAB = register("end_stone_brick_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.END_STONE_BRICKS)), ItemGroup.BUILDING_BLOCKS);
	public static final Block PURPUR_VERTICAL_SLAB = register("purpur_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.PURPUR_BLOCK)), ItemGroup.BUILDING_BLOCKS);
	public static final Block PRISMARINE_VERTICAL_SLAB = register("prismarine_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.PRISMARINE)), ItemGroup.BUILDING_BLOCKS);
	public static final Block PRISMARINE_BRICK_VERTICAL_SLAB = register("prismarine_brick_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.PRISMARINE_BRICKS)), ItemGroup.BUILDING_BLOCKS);
	public static final Block DARK_PRISMARINE_VERTICAL_SLAB = register("dark_prismarine_vertical_slab", new VerticalSlabBlock(Settings.copy(Blocks.DARK_PRISMARINE)), ItemGroup.BUILDING_BLOCKS);
