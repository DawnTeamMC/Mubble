...
public class MubbleRenderLayers
{
	public static void init()
	{
		...
		// Saplings
		BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutout(), MubbleBlocks.AUTUMN_OAK_SAPLING,
		...
		// Leaves
		BlockRenderLayerMap.INSTANCE.putBlocks(RenderLayer.getCutoutMipped(), MubbleBlocks.AUTUMN_OAK_LEAVES,
