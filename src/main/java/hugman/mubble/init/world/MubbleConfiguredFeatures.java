...
public class MubbleConfiguredFeatures {
	...
	public static final ConfiguredFeature<?, ?> PATCH_AUTUMN_OAK_LEAF_PILE = register("patch_autumn_oak_leaf_pile", Configs.leafPilePatch(States.AUTUMN_OAK_LEAF_PILE));
	...
	public static final ConfiguredFeature<?, ?> PATCH_AUTUMN_BIRCH_LEAF_PILE = register("patch_autumn_birch_leaf_pile", Configs.leafPilePatch(States.AUTUMN_BIRCH_LEAF_PILE));
	...
	public static final ConfiguredFeature<?, ?> PATCH_PINK_CHERRY_OAK_LEAF_PILE = register("patch_pink_cherry_oak_leaf_pile", Configs.leafPilePatch(States.PINK_CHERRY_OAK_LEAF_PILE));
	...
	public static final ConfiguredFeature<?, ?> PATCH_WHITE_CHERRY_OAK_LEAF_PILE = register("patch_white_cherry_oak_leaf_pile", Configs.leafPilePatch(States.WHITE_CHERRY_OAK_LEAF_PILE));
	...
	public static final ConfiguredFeature<?, ?> PATCH_BLUE_MUSHROOM = register("patch_blue_mushroom", Configs.mushroomPatch(States.BLUE_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_CYAN_MUSHROOM = register("patch_cyan_mushroom", Configs.mushroomPatch(States.CYAN_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_YELLOW_MUSHROOM = register("patch_yellow_mushroom", Configs.mushroomPatch(States.YELLOW_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_ORANGE_MUSHROOM = register("patch_orange_mushroom", Configs.mushroomPatch(States.ORANGE_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_PINK_MUSHROOM = register("patch_pink_mushroom", Configs.mushroomPatch(States.PINK_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_MAGENTA_MUSHROOM = register("patch_magenta_mushroom", Configs.mushroomPatch(States.MAGENTA_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_WHITE_MUSHROOM = register("patch_white_mushroom", Configs.mushroomPatch(States.WHITE_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_LIGHT_GRAY_MUSHROOM = register("patch_light_gray_mushroom", Configs.mushroomPatch(States.LIGHT_GRAY_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_GRAY_MUSHROOM = register("patch_gray_mushroom", Configs.mushroomPatch(States.GRAY_MUSHROOM));
	public static final ConfiguredFeature<?, ?> PATCH_BLACK_MUSHROOM = register("patch_black_mushroom", Configs.mushroomPatch(States.BLACK_MUSHROOM));
	...
	public static final ConfiguredFeature<?, ?> HUGE_NETHER_MUSHROOM_CYAN_FLAT = register("huge_nether_mushroom_cyan_flat", MubbleFeatures.HUGE_NETHER_MUSHROOM.configure(Configs.HUGE_NETHER_MUSHROOM_CYAN.setFlatHat()));
	...
	public static final ConfiguredFeature<?, ?> HUGE_NETHER_MUSHROOM_CYAN_UPSIDE_FLAT = register("huge_nether_mushroom_cyan_upside_flat", MubbleFeatures.HUGE_NETHER_MUSHROOM.configure(Configs.HUGE_NETHER_MUSHROOM_CYAN.setFlatHat().setUpsideDown()));
	...
	public static final TreeFeatureConfig MEGA_RED_PRESS_GARDEN_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PRESS_GARDEN_LOG), new SimpleBlockStateProvider(States.RED_PRESS_GARDEN_LEAVES), new JungleFoliagePlacer(2, 0, 0, 0, 2), new MegaJungleTrunkPlacer(30, 2, 20), new TwoLayersFeatureSize(1, 1, 2))).build();
	public static final RandomPatchFeatureConfig RED_PRESS_GARDEN_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(States.RED_PRESS_GARDEN_LEAF_PILE), SimpleBlockPlacer.INSTANCE)).tries(32).build();
	public static final TreeFeatureConfig PINK_PRESS_GARDEN_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PRESS_GARDEN_LOG), new SimpleBlockStateProvider(States.PINK_PRESS_GARDEN_LEAVES), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build();
	public static final TreeFeatureConfig FANCY_PINK_PRESS_GARDEN_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PRESS_GARDEN_LOG), new SimpleBlockStateProvider(States.PINK_PRESS_GARDEN_LEAVES), new LargeOakFoliagePlacer(2, 0, 4, 0, 4), new LargeOakTrunkPlacer(3, 11, 0), new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4)))).ignoreVines().heightmap(Type.MOTION_BLOCKING).build();
	public static final TreeFeatureConfig MEGA_PINK_PRESS_GARDEN_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PRESS_GARDEN_LOG), new SimpleBlockStateProvider(States.PINK_PRESS_GARDEN_LEAVES), new JungleFoliagePlacer(2, 0, 0, 0, 2), new MegaJungleTrunkPlacer(30, 2, 20), new TwoLayersFeatureSize(1, 1, 2))).build();
	public static final RandomPatchFeatureConfig PINK_PRESS_GARDEN_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(States.PINK_PRESS_GARDEN_LEAF_PILE), SimpleBlockPlacer.INSTANCE)).tries(32).build();
	public static final TreeFeatureConfig PINK_PRESS_GARDEN_GROUND_BUSH_PATCHES = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.PRESS_GARDEN_LOG), new SimpleBlockStateProvider(States.PINK_PRESS_GARDEN_LEAVES), new BushFoliagePlacer(2, 0, 1, 0, 2), new StraightTrunkPlacer(1, 0, 0), new TwoLayersFeatureSize(0, 0, 0))).heightmap(Type.MOTION_BLOCKING_NO_LEAVES).build();

	public static final ConfiguredFeature<?, ?> PATCH_BLUEBERRY_BUSH = register("patch_blueberry_bush", Configs.berryBushPatch(States.BLUEBERRY_BUSH));
	...
	public static final TreeFeatureConfig SCARLET_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SCARLET_LOG), new SimpleBlockStateProvider(States.SCARLET_LEAVES), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).ignoreVines().build();
	public static final TreeFeatureConfig FANCY_SCARLET_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SCARLET_LOG), new SimpleBlockStateProvider(States.SCARLET_LEAVES), new LargeOakFoliagePlacer(2, 0, 4, 0, 4), new LargeOakTrunkPlacer(3, 11, 0), new TwoLayersFeatureSize(0, 0, 0, OptionalInt.of(4)))).ignoreVines().heightmap(Type.MOTION_BLOCKING).build();
	public static final TreeFeatureConfig HUGE_SCARLET_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SCARLET_LOG), new SimpleBlockStateProvider(States.SCARLET_LEAVES), new DarkOakFoliagePlacer(0, 0, 0, 0), new DarkOakTrunkPlacer(6, 2, 1), new ThreeLayersFeatureSize(1, 1, 0, 1, 2, OptionalInt.empty()))).maxWaterDepth(2147483647).heightmap(Type.MOTION_BLOCKING).ignoreVines().build();
	public static final RandomPatchFeatureConfig SCARLET_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(States.SCARLET_LEAF_PILE), SimpleBlockPlacer.INSTANCE)).tries(32).build();
	public static final TreeFeatureConfig SCARLET_GROUND_BUSH = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(States.SCARLET_LOG), new SimpleBlockStateProvider(States.SCARLET_LEAVES), new BushFoliagePlacer(2, 0, 1, 0, 2), new StraightTrunkPlacer(1, 0, 0), new TwoLayersFeatureSize(0, 0, 0))).heightmap(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES).build();

	public static final ConfiguredFeature<?, ?> PATCH_SCARLET_MUSHROOM = register("patch_scarlet_mushroom", Configs.mushroomPatch(States.SCARLET_MUSHROOM));
	...
	public static final RandomPatchFeatureConfig SCARLET_ORCHID_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(States.SCARLET_ORCHID), SimpleBlockPlacer.field_24871)).tries(64).build();
	...
	public static final class Configs {
		...
		protected static final HugeNetherMushroomFeatureConfig HUGE_NETHER_MUSHROOM_WHITE = new HugeNetherMushroomFeatureConfig(6, 2, MubbleBlocks.WHITE_MUSHROOM_BLOCK.getDefaultState(), 2, 1, Blocks.SHROOMLIGHT.getDefaultState(), 0.05F, 0.0F);
		protected static final HugeNetherMushroomFeatureConfig HUGE_NETHER_MUSHROOM_LIGHT_GRAY = new HugeNetherMushroomFeatureConfig(4, 7, MubbleBlocks.LIGHT_GRAY_MUSHROOM_BLOCK.getDefaultState(), 3, 1, Blocks.SHROOMLIGHT.getDefaultState(), 0.05F, 0.0F);
		protected static final HugeNetherMushroomFeatureConfig HUGE_NETHER_MUSHROOM_GRAY = new HugeNetherMushroomFeatureConfig(4, 7, MubbleBlocks.GRAY_MUSHROOM_BLOCK.getDefaultState(), 3, 1, Blocks.SHROOMLIGHT.getDefaultState(), 0.01F, 0.0F);
		protected static final HugeNetherMushroomFeatureConfig HUGE_NETHER_MUSHROOM_BLACK = new HugeNetherMushroomFeatureConfig(6, 2, MubbleBlocks.BLACK_MUSHROOM_BLOCK.getDefaultState(), 2, 1, Blocks.SHROOMLIGHT.getDefaultState(), 0.01F, 0.0F);

		protected final static ConfiguredFeature<RandomPatchFeatureConfig, ?> leafPilePatch(BlockState blockState) {
			return Feature.RANDOM_PATCH.configure((new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(blockState), SimpleBlockPlacer.INSTANCE).tries(32)).cannotProject().build());
		}

		protected final static ConfiguredFeature<RandomPatchFeatureConfig, ?> berryBushPatch(BlockState blockState) {
		...
		protected final static ConfiguredFeature<RandomPatchFeatureConfig, ?> mushroomPatch(BlockState blockState) {
