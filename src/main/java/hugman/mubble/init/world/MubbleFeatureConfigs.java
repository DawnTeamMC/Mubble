...
public class MubbleFeatureConfigs
{
	...
	/* MINECRAFT */
	public static final TreeFeatureConfig AUTUMN_OAK_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(OAK_LOG), new SimpleBlockStateProvider(AUTUMN_OAK_LEAVES), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).method_27374().build();
	...
	public static final TreeFeatureConfig AUTUMN_BIRCH_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(BIRCH_LOG), new SimpleBlockStateProvider(AUTUMN_BIRCH_LEAVES), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).method_27374().build();
	...
	public static final RandomPatchFeatureConfig AUTUMN_OAK_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(AUTUMN_OAK_LEAF_PILE), new SimpleBlockPlacer())).tries(16).build();
	public static final RandomPatchFeatureConfig AUTUMN_BIRCH_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(AUTUMN_BIRCH_LEAF_PILE), new SimpleBlockPlacer())).tries(16).build();
	...
	public static final TreeFeatureConfig PINK_CHERRY_OAK_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(CHERRY_OAK_LOG), new SimpleBlockStateProvider(PINK_CHERRY_OAK_LEAVES), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(5, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).method_27374().build();
	...
	public static final RandomPatchFeatureConfig PINK_CHERRY_OAK_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(PINK_CHERRY_OAK_LEAF_PILE), new SimpleBlockPlacer())).tries(32).build();
	public static final RandomPatchFeatureConfig PINK_MUSHROOM_PATCHES = mushroomConfig(MubbleBlocks.WHITE_MUSHROOM);
	public static final RandomPatchFeatureConfig MAGENTA_MUSHROOM_PATCHES = mushroomConfig(MubbleBlocks.LIGHT_GRAY_MUSHROOM);

	public static final TreeFeatureConfig WHITE_CHERRY_OAK_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(CHERRY_OAK_LOG), new SimpleBlockStateProvider(WHITE_CHERRY_OAK_LEAVES), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(5, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).method_27374().build();
	...
	public static final RandomPatchFeatureConfig WHITE_CHERRY_OAK_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(WHITE_CHERRY_OAK_LEAF_PILE), new SimpleBlockPlacer())).tries(32).build();
	...
	public static final TreeFeatureConfig PALM_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(PALM_LOG), new SimpleBlockStateProvider(PALM_LEAVES), new AcaciaFoliagePlacer(2, 0, 0, 0), new ForkingTrunkPlacer(16, 2, 2), new TwoLayersFeatureSize(1, 0, 1))).method_27374().build();

	public static final RandomPatchFeatureConfig BLUEBERRY_BUSH_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(BLUEBERRY_BUSH), new SimpleBlockPlacer())).tries(64).whitelist(ImmutableSet.of(Blocks.GRASS_BLOCK)).cannotProject().build();

	public static final HugeNetherMushroomFeatureConfig YELLOW_HUGE_NETHER_MUSHROOM = new HugeNetherMushroomFeatureConfig(Blocks.MUSHROOM_STEM.getDefaultState(), MubbleBlocks.YELLOW_MUSHROOM_BLOCK.getDefaultState(), false, 2, Blocks.SHROOMLIGHT.getDefaultState());
	public static final HugeNetherMushroomFeatureConfig MAGENTA_HUGE_NETHER_MUSHROOM = new HugeNetherMushroomFeatureConfig(Blocks.MUSHROOM_STEM.getDefaultState(), MubbleBlocks.MAGENTA_MUSHROOM_BLOCK.getDefaultState(), false, 2, Blocks.SHROOMLIGHT.getDefaultState());
	...
	public static final RandomPatchFeatureConfig RED_PRESS_GARDEN_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(RED_PRESS_GARDEN_LEAF_PILE), new SimpleBlockPlacer())).tries(32).build();
	public static final TreeFeatureConfig PINK_PRESS_GARDEN_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(PRESS_GARDEN_LOG), new SimpleBlockStateProvider(PINK_PRESS_GARDEN_LEAVES), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).method_27374().build();
	...
	public static final RandomPatchFeatureConfig PINK_PRESS_GARDEN_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(PINK_PRESS_GARDEN_LEAF_PILE), new SimpleBlockPlacer())).tries(32).build();
	...
	/* DELTARUNE */
	public static final TreeFeatureConfig SCARLET_TREE = (new TreeFeatureConfig.Builder(new SimpleBlockStateProvider(SCARLET_LOG), new SimpleBlockStateProvider(SCARLET_LEAVES), new BlobFoliagePlacer(2, 0, 0, 0, 3), new StraightTrunkPlacer(4, 2, 0), new TwoLayersFeatureSize(1, 0, 1))).method_27374().build();
	...
	public static final RandomPatchFeatureConfig SCARLET_LEAF_PILE_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(SCARLET_LEAF_PILE), new SimpleBlockPlacer())).tries(32).build();
	...
	public static final RandomPatchFeatureConfig SCARLET_ORCHID_PATCHES = (new RandomPatchFeatureConfig.Builder(new SimpleBlockStateProvider(SCARLET_ORCHID), new SimpleBlockPlacer())).tries(64).build();
