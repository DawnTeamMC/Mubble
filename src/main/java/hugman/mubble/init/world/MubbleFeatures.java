...
import hugman.mubble.objects.world.gen.feature.EnderBoulderFeature;
...
public class MubbleFeatures {
	...
	public static final Feature<ForestRockFeatureConfig> ENDER_BOULDER = register("ender_boulder", new EnderBoulderFeature(ForestRockFeatureConfig.CODEC));
