...
import com.hugman.mubble.object.entity.ZombieCowmanEntity;
...
public class ZombieCowmanEntityRenderer extends BipedEntityRenderer<ZombieCowmanEntity, ZombieEntityModel<ZombieCowmanEntity>> {
	private static final Identifier ZOMBIE_COWMAN_TEXTURE = Mubble.MOD_DATA.id("textures/entity/zombie_cowman.png");
