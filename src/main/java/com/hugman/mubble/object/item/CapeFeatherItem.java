...
public class CapeFeatherItem extends Item {
	...
	public TypedActionResult<ItemStack> use(World worldIn, PlayerEntity playerIn, Hand handIn) {
		...
		worldIn.playSound(null, playerIn.getX(), playerIn.getY(), playerIn.getZ(), MubbleSoundPack.ITEM_CAPE_FEATHER_USE, SoundCategory.PLAYERS, 0.5F, 1F);
		...
		if(!playerIn.abilities.creativeMode && this != MubbleItemPack.SUPER_CAPE_FEATHER) {
			stack.decrement(1);
		}
