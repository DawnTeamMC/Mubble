...
public class MubbleEntities extends MubblePack {
	...
	public static final EntityType<GoombaEntity> GOOMBA = register(new EntityCreator.Builder<>("goomba", FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, GoombaEntity::new).dimensions(EntityDimensions.fixed(0.6F, 0.9F)).trackRangeChunks(8).trackedUpdateRate(3).build()).attributes(GoombaEntity.createGoombaAttributes()));
