...
public class MubbleBlocks extends MubblePack {
	/* MUBBLE */
	public static final Block BLUE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("blue_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_BLUE))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block LIGHT_BLUE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("light_blue_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_LIGHT_BLUE))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block PURPLE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("purple_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_PURPLE))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block MAGENTA_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("magenta_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_MAGENTA))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block PINK_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("pink_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_PINK))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block RED_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("red_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_RED))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block ORANGE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("orange_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_ORANGE))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block YELLOW_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("yellow_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_YELLOW))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block GREEN_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("green_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_GREEN))).itemGroup(ItemGroup.DECORATIONS));
	public static final Block WHITE_CHRISTMAS_BAUBLE = register(new BlockCreator.Builder("white_christmas_bauble", new Block(Settings.CHRISTMAS_BAUBLE.materialColor(MapColor.TERRACOTTA_WHITE))).itemGroup(ItemGroup.DECORATIONS));
	...
	public static final Block SILVER_SHINY_GARLAND = register(new BlockCreator.Builder("silver_shiny_garland", new GarlandBlock(FabricBlockSettings.of(Material.LEAVES, MapColor.IRON_GRAY).hardness(0.2F).sounds(BlockSoundGroup.GRASS))).itemGroup(ItemGroup.DECORATIONS).flammability(30, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	...
	public static final Block WHITE_PRESENT = register(new BlockCreator.Builder("white_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.TERRACOTTA_WHITE).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block BLACK_PRESENT = register(new BlockCreator.Builder("black_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.TERRACOTTA_BLACK).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block BLUE_PRESENT = register(new BlockCreator.Builder("blue_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.TERRACOTTA_BLUE).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block GREEN_PRESENT = register(new BlockCreator.Builder("green_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.TERRACOTTA_GREEN).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block YELLOW_PRESENT = register(new BlockCreator.Builder("yellow_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.TERRACOTTA_YELLOW).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block RED_PRESENT = register(new BlockCreator.Builder("red_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.TERRACOTTA_RED).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	public static final Block PURPLE_PRESENT = register(new BlockCreator.Builder("purple_present", new PresentBlock(FabricBlockSettings.of(Material.WOOD, MapColor.TERRACOTTA_PURPLE).hardness(0.8F).sounds(BlockSoundGroup.WOOD))).itemGroup(ItemGroup.DECORATIONS).flammability(60, 60).render(BlockCreator.Render.CUTOUT_MIPPED));
	...
	public static final Block LIGHT_BLOCK = register(new BlockCreator.Builder("light_block", new Block(FabricBlockSettings.of(Material.STONE, MapColor.STONE_GRAY).strength(1.5F, 6.0F).luminance(15))));
	...
	public static final WoodPack PRESS_GARDEN_WOOD = register(new WoodPack.Builder("press_garden", MapColor.field_25702, MapColor.field_25703, MapColor.field_25707, false));
	...
	/* UNDERTALE / DELTARUNE */
	public static final NormalWoodPack SCARLET_WOOD = register(new NormalWoodPack.Builder("scarlet", new ScarletSaplingGenerator(), MapColor.field_25702, MapColor.field_25703, MapColor.field_25707));
	...
	public static final Block ELDER_PEBBLES = register(new BlockCreator.Builder("elder_pebbles", new Block(FabricBlockSettings.of(Material.STONE, MapColor.RED).strength(2.0F, 6.0F).luminance(5))).itemGroup(ItemGroup.BUILDING_BLOCKS));
	...
	public static final Block TURQUOISE_PUYO = register(new BlockCreator.Builder("turquoise_puyo", new PuyoBlock(FabricBlockSettings.of(Material.ORGANIC_PRODUCT, MapColor.EMERALD_GREEN).slipperiness(0.8F).sounds(BlockSoundGroup.SLIME))).noItem());
	...
	public static final Block POINT_PUYO = register(new BlockCreator.Builder("point_puyo", new DirectionalBlock(FabricBlockSettings.of(Material.STONE, MapColor.STONE_GRAY).strength(1.5F, 6.0F).luminance(10))).noItem());
	...
	public static class Settings {
		...
		public static final FabricBlockSettings BRICK_BLOCK = FabricBlockSettings.of(Material.STONE, MapColor.RED).strength(2.0F, 6.0F);
