...
public class MubbleCostumes extends MubblePack {
	/* MUBBLE */
	public static final Item HEADPHONES = register(new ItemCreator.Builder("headphones", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON)));
	public static final Item WHITE_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("white_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.WHITE_RETRO)));
	public static final Item LIGHT_GRAY_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("light_gray_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.LIGHT_GRAY_RETRO)));
	public static final Item GRAY_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("gray_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.GRAY_RETRO)));
	public static final Item BLACK_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("black_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.BLACK_RETRO)));
	public static final Item BROWN_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("brown_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.BROWN_RETRO)));
	public static final Item RED_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("red_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.RED_RETRO)));
	public static final Item ORANGE_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("orange_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.ORANGE_RETRO)));
	public static final Item YELLOW_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("yellow_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.YELLOW_RETRO)));
	public static final Item LIME_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("lime_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.LIME_RETRO)));
	public static final Item GREEN_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("green_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.GREEN_RETRO)));
	public static final Item CYAN_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("cyan_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.CYAN_RETRO)));
	public static final Item LIGHT_BLUE_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("light_blue_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.LIGHT_BLUE_RETRO)));
	public static final Item BLUE_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("blue_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.BLUE_RETRO)));
	public static final Item PURPLE_VIRTUAL_GOOGLES = register(new ItemCreator.Builder("purple_virtual_googles", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON, MubbleShaders.PURPLE_RETRO)));
	...
	public static final Item SILVER_LUIGI_CAP = register(new ItemCreator.Builder("silver_luigi_cap", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON)));
	public static final Item PRINCESS_PEACH_CROWN = register(new ItemCreator.Builder("princess_peach_crown", new CrownCostume(Settings.COSTUME, Princess.PEACH)));
	public static final Item PRINCESS_DAISY_CROWN = register(new ItemCreator.Builder("princess_daisy_crown", new CrownCostume(Settings.COSTUME, Princess.DAISY)));
	public static final Item ROSALINA_CROWN = register(new ItemCreator.Builder("rosalina_crown", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON)));
	public static final Item PINK_GOLD_PEACH_CROWN = register(new ItemCreator.Builder("pink_gold_peach_crown", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON)));
	public static final Item SUPER_CROWN = register(new ItemCreator.Builder("super_crown", new HeadCostume(Settings.COSTUME, SoundEvents.ITEM_ARMOR_EQUIP_IRON)));
	...
	public static final Item GREEN_PUYO = register(new ItemCreator.Builder("green_puyo", new BlockCostume(Settings.DECORATION_BLOCK, SoundEvents.BLOCK_SLIME_BLOCK_PLACE, EquipmentSlot.HEAD, MubbleBlocks.GREEN_PUYO)));
	public static final Item TURQUOISE_PUYO = register(new ItemCreator.Builder("turquoise_puyo", new BlockCostume(Settings.DECORATION_BLOCK, SoundEvents.BLOCK_SLIME_BLOCK_PLACE, EquipmentSlot.HEAD, MubbleBlocks.TURQUOISE_PUYO)));
	public static final Item BLUE_PUYO = register(new ItemCreator.Builder("blue_puyo", new BlockCostume(Settings.DECORATION_BLOCK, SoundEvents.BLOCK_SLIME_BLOCK_PLACE, EquipmentSlot.HEAD, MubbleBlocks.BLUE_PUYO)));
	public static final Item PURPLE_PUYO = register(new ItemCreator.Builder("purple_puyo", new BlockCostume(Settings.DECORATION_BLOCK, SoundEvents.BLOCK_SLIME_BLOCK_PLACE, EquipmentSlot.HEAD, MubbleBlocks.PURPLE_PUYO)));
	public static final Item GRAY_PUYO = register(new ItemCreator.Builder("gray_puyo", new BlockCostume(Settings.DECORATION_BLOCK, SoundEvents.BLOCK_SLIME_BLOCK_PLACE, EquipmentSlot.HEAD, MubbleBlocks.GRAY_PUYO)));
	public static final Item GARBAGE_PUYO = register(new ItemCreator.Builder("garbage_puyo", new BlockCostume(Settings.DECORATION_BLOCK, SoundEvents.BLOCK_STONE_PLACE, EquipmentSlot.HEAD, MubbleBlocks.GARBAGE_PUYO)));
