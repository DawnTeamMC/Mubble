...
public class MubbleBlockPack extends MubblePack {
	...
	public static final MSBlockPack PERMAFROST_BRICKS = register(new MSBlockPack.Builder("permafrost_bricks", FabricBlockSettings.copyOf(Blocks.NETHER_BRICKS), DefaultBlockGetter.CUBE, DefaultBlockGetter.STAIRS, DefaultBlockGetter.SLAB, DefaultBlockGetter.VERTICAL_SLAB, DefaultBlockGetter.FENCE));
	public static final MSBlockPack BLUE_PERMAFROST_BRICKS = register(new MSBlockPack.Builder("blue_permafrost_bricks", FabricBlockSettings.copyOf(Blocks.RED_NETHER_BRICKS), DefaultBlockGetter.CUBE, DefaultBlockGetter.STAIRS, DefaultBlockGetter.SLAB, DefaultBlockGetter.VERTICAL_SLAB, DefaultBlockGetter.WALL));
	...
	public static final MSBlockPack MEDUSA_BRICKS = register(new MSBlockPack.Builder("medusa_bricks", FabricBlockSettings.copyOf(Blocks.STONE_BRICKS), DefaultBlockGetter.CUBE, DefaultBlockGetter.STAIRS, DefaultBlockGetter.SLAB, DefaultBlockGetter.VERTICAL_SLAB, DefaultBlockGetter.WALL));
	...
	public static final MSBlockPack MIRROR_TEMPLE_BRICKS = register(new MSBlockPack.Builder("mirror_temple_bricks", FabricBlockSettings.copyOf(Blocks.BRICKS), DefaultBlockGetter.CUBE, DefaultBlockGetter.STAIRS, DefaultBlockGetter.SLAB, DefaultBlockGetter.VERTICAL_SLAB, DefaultBlockGetter.WALL));
	public static final MSBlockPack OLD_SITE_BRICKS = register(new MSBlockPack.Builder("old_site_bricks", FabricBlockSettings.copyOf(Blocks.BRICKS), DefaultBlockGetter.CUBE, DefaultBlockGetter.STAIRS, DefaultBlockGetter.SLAB, DefaultBlockGetter.VERTICAL_SLAB, DefaultBlockGetter.WALL));
